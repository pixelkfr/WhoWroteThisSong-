...
def classifie_test1( class1 , class2 , class3 , fileOut , dirname ):
    ...
    for chanson in listeChansons:
        ...
        elif (motifsCommuns2 > motifsCommuns1) and (motifsCommuns2 > motifsCommuns3):
			fileOut_obj.write(chanson + " ; artiste 2" +"\n")
        elif (motifsCommuns3 > motifsCommuns1) and (motifsCommuns3 > motifsCommuns2):
			fileOut_obj.write(chanson + " ; artiste 3" +"\n")
        else:
